 ...
 * read back a schedule lives behind this file — `src/engine/*` is
 * implementation detail (placement search, backtracking, cost internals)
 * and should not be imported directly outside `src/engine`. The full
 * behavioral specification is `SPEC.md`; this file is the
