...
Modified principles:
  - V. Simplicity (YAGNI) → V. Simplicity First (YAGNI) (renamed; expanded with the
    explicit post-write simplicity review and the "three similar lines beat a premature
    abstraction" rule)
Added sections:
  - Core Principles: VI. Incremental Delivery (Thin Vertical Slices), VII. Scope Discipline
  - Development Workflow: "Increment Checklist" and "Slicing Strategies" subsections
...
Templates requiring updates:
  ...
  - .specify/templates/tasks-template.md ✅ updated (Notes section now references the
    per-increment verification gates required by Principle VI)
